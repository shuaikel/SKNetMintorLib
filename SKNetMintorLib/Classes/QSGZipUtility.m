...
+ (NSData*)gzipData:(NSData *)pUncompressedData {
    ...
    if (!pUncompressedData || [pUncompressedData length] == 0) {
        NSLog(@" Error: Can't compress an empty or null NSData object.");
        return nil;
    }
    ...
    do {
        ...
        if (initError != Z_OK) {
            ...
            NSLog(@"deflateInit2() Error: \"%@\" Message: \"%s\"", errorMsg, zlibStreamStruct.msg);
            return nil;
        }
        ...
        if (deflateStatus != Z_STREAM_END) {
            ...
            NSLog(@"zlib error while attempting compression: \"%@\" Message: \"%s\"", errorMsg, zlibStreamStruct.msg);
